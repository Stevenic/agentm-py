...
class Logger:
    ...
    def __init__(self, settings_path=None, *, allow_missing=False):
        """
        ...
        self.settings = ({} if allow_missing and not os.path.exists(settings_path)
                         else self.load_settings(settings_path))
